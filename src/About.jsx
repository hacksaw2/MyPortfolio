  ...
  return (
    <div className='bg-gray-300 h-full '>
      <div className="x lg:flex  ">
        <div className="content1 text-5xl  w-[100vw] lg:w-[50vw]  flex justify-center   text-center h-[100vh] mt-8 ">
          <div className="n">
          <div className="cooo bg-red-500 p-4 ml-2 w-[95vw] lg:w-[45vw] rounded-e-3xl ">
            <div className="y">I am a web developer  skilled in <p className='mt-4 text-purple-800'>MERN Stack.</p></div>
            <div className="symbol lg:ml-[10vw] mr-5 mt-[5vh]"><MernIcon /></div>
          </div>

          <div className="arrow justify-center mt-20  flex">
...
GET STARTED<svg c
  ...
  >
    <path d="M12 2l10 10-10 10-1.41-1.41L18.17 12H2v-2h16.17l-7.59-7.59L12 2z" />
        ...
        <div className="content2 text-5xl  h-[100vh] lg:w-[50vw] flex justify-center   text-center  ">
          <div className="nooo border-[1px] w-[95vw] border-blue-300 bg-gradient-to-br from-gray-400 via-gray-300 to-slate-400  h-[50vh]   lg:w-[40vw] lg:h-[80vh] p-4 rounded-3xl shadow-2xl shadow-gray-600 lg:mt-8   ">
            <div className="m flex justify-center ">
              ...
              <div className="skills flex justify-center gap-10  ">
                ...
                <div className="html  ">
                  ...
                  <h1 className='text-xl text-center'>HTML(2022-2024)</h1>
                ...
                <div className="css  ">
                  ...
                  <h1 className='text-xl text-center'>CSS(2022-2024)</h1>
                </div>
                ...
                <div className="javascript ">
                  ...
                  <h1 className='text-xl text-center'>Javascript(2022-2024)</h1>
                </div>
